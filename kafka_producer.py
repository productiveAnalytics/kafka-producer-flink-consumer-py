...
# Install Conflent Kafka package
...
SELLERS = ['AUSTIN', 'BOSTON', 'CHICAGO', 'DENVER', 'EMORY', 'FRANKLIN', 'GAURI', 'HALO', 
'INDIA', 'JACKSON', 'KANAB', 'LONDON', 'MBORO', 'NASHVILLE', 'ORANGE', 'POMOA',
'QUINCY', 'RAM', 'SEATTLE', 'TOMATO', 'URBANA', 'VENICE', 'WAMU', 'XIAXIA',
'YELLOWSTONE', 'ZIP']
